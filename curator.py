...
if __name__ == "__main__":
    ...
    if not(os.path.exists(os.path.join(options.tmp_dir, "FINISHED_DEMULTIPLEXING"))):
    #===parse reads===
        ...
        Path(os.path.join(options.tmp_dir, "FINISHED_DEMULTIPLEXING")).touch()
        ...
        print("Reads already separated by cell barcode. Skipping.")
        logger.write("Reads already separated by cell barcode. Skipping.")
